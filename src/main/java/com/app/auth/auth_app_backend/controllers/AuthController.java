...
import com.app.auth.auth_app_backend.dto.LoginRequest;
import com.app.auth.auth_app_backend.dto.RequestTokenRequest;
import com.app.auth.auth_app_backend.dto.TokenResponse;
...
public class AuthController {
    ...
    //To refresh renew, and access token


    @PostMapping("/refresh")
    public ResponseEntity<TokenResponse> refreshToken(
            @RequestBody(required = false) RequestTokenRequest body,
    ...
    private Optional<String> readRefreshTokenFromRequest(RequestTokenRequest body, HttpServletRequest request) {
